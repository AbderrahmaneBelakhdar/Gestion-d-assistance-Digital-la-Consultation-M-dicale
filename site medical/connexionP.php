...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid ps-md-0">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-9 col-lg-8 mx-auto">
                  <h3 class="login-heading mb-4">Espace patient                 </h3>
      ...
      if(empty($emailP) || empty($passwordP)){
       echo "<div class='alert alert-danger'>"."Veuillez entrer une adresse email et un mot de passe valide." . "</div>" ;
      }      
    else 
    {  //
$query ="SELECT * FROM informationsp WHERE EmailP='$emailP' and  PasswordP='$passwordP'";
          ...
          ?>
                  ...
                  <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post"   >
                    <div class="form-floating mb-3">
                      <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="EmailP" >
                      <label for="floatingInput">Email address</label>
                    </div>
                    <div class="form-floating mb-3">
                      <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="PasswordP">
                    ...
                    <div class="d-grid">
                      ...
                      <div class="text-center">
                        <a class="small" href="inscriptionP.html"> <h5>Êtes-vous nouveau sur le service?      </h5>  </a>
                      </div>
                    </div>
